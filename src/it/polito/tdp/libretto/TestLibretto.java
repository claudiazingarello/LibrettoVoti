...
public class TestLibretto {
	...
	public static void main(String[] args) {
		//uso una classe separata, in modo da essere certo
		//di avere usato tutti i metodi privati nella classe Libretto
		...
		System.out.format("Il voto %s è in conflitto %s\n", giusto.toString(), 
				libr.votoConflitto(giusto));
		System.out.format("Il voto %s è in conflitto %s\n", sbagliato.toString(), 
				libr.votoConflitto(sbagliato));
		System.out.format("Il voto %s è in conflitto %s\n", mancante.toString(), 
				libr.votoConflitto(mancante));
		
		System.out.println(libr.add(giusto));
		System.out.println(libr.add(sbagliato));
		System.out.println(libr.add(mancante));
		
		System.out.println(libr.toString()); //stampiamo il libretto alla fine
	}
